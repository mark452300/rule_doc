...
- MUST keep code clean, readable, and cohesive; use design patterns only when they simplify real problems and improve maintainability without unnecessary complexity.
