...
## Debugging Missing or Incorrect Output

For missing or incorrect output, trace backward from the observed result to the first divergent boundary. Compare parallel representations of the same data, then fix the owning synchronization, normalization, or contract boundary instead of adding downstream fallbacks. Verify with the narrowest relevant check and review the diff for unrelated changes.
